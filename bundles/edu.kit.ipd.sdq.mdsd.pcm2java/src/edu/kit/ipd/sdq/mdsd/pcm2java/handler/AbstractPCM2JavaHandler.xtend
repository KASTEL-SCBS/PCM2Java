...
abstract class AbstractPCM2JavaHandler extends AbstractEcoreIFile2TxtHandler {
	...
	override executeEcore2TxtGenerator(List<IFile> filteredSelection, ExecutionEvent event, String plugInID) throws ExecutionException {
		...
		Ecore2TxtUtil.generateFromSelectedFilesInFolder(filteredSelection,new PCM2JavaGeneratorModule(),new PCM2JavaGenerator(userConfiguration), false, false)
	}
